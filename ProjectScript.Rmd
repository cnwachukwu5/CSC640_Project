...
data_testrunevent2 <- data_testrunevent %>% select(day, Result) %>% filter(Result == "Success") %>% sample_n(2416)
data_testrunevent2 <- data_testrunevent2 %>% filter(!is.na(data_testrunevent2$Result) & !is.na(data_testrunevent2$day))

#data_testrunevent2_failure <- data_testrunevent %>% select(day, Result) %>% filter(Result == "Failed") %>% sample_n(1563)

#data_testrunevent2_failure
```
